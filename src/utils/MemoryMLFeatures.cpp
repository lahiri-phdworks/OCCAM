...
MLFeaturesCallSite::MLFeaturesCallSite(CallSite &CS)
    : m_cs(CS.getInstruction()), callee_nodes(0), callee_collapsed(0),
      callee_accessed(0), callee_sequence(0), callee_alloca(0), callee_heap(0),
      callee_external(0), callee_pointers(0), callee_alloc_sites(0),
      callee_mem_accesses(0), callee_safe_alloc_sites(0),
      ////
      td_callee_nodes(0), td_callee_collapsed(0), td_callee_accessed(0),
      td_callee_sequence(0), td_callee_alloca(0), td_callee_heap(0),
      td_callee_external(0), td_callee_pointers(0), td_callee_alloc_sites(0),

...
declare dso_local i32 @libcall_float(i32, float) local_unnamed_addr #1

declare dso_local i32 @libcall_double(i32, double) local_unnamed_addr #1

declare dso_local i32 @libcall_null_pointer(i32, i8*) local_unnamed_addr #1

declare dso_local i32 @libcall_string(i32, i8*) local_unnamed_addr #1
...
entry1:                                           ; preds = %entry
  ...
  %26 = tail call i32 @libcall_float(i32 %25, float 5.000000e-01) #3
  %27 = mul nsw i32 %23, %26
  %28 = tail call i64 @strlen(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @new_argv.1, i64 0, i64 0)) #2
  %29 = trunc i64 %28 to i32
  %30 = tail call i32 @libcall_double(i32 %29, double 7.500000e-01) #3
  %31 = mul nsw i32 %27, %30
  %32 = tail call i32 @libcall_null_pointer(i32 4, i8* null) #3
  %33 = mul nsw i32 %31, %32
  %34 = tail call i32 @libcall_string(i32 5, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  ...
  %42 = tail call i32 @libcall_global_pointer(i32 %41, i8* null) #3

; ModuleID = 'slash/main.a.i.p.s.r.i.h.p.s.r.i.bc'
...
entry1:                                           ; preds = %entry
  ...
  %8 = tail call i32 @"__occam_spec.fibo_lib(0xF)"()
  %9 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i32 15, i32 %8) #1
...
declare i32 @"__occam_spec.fibo_lib(0xF)"() local_unnamed_addr

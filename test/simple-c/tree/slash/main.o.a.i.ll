...
13:                                               ; preds = %2
  ...
  %27 = call i32 @internal_api(i32 3, i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  %28 = mul nsw i32 %26, %27
  %29 = call i32 @internal_api(i32 4, i8* null, i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %30 = mul nsw i32 %28, %29
  %31 = call i32 @internal_api(i32 5, i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* bitcast (i32 (i32, i8**)* @0 to i8*))
...
34:                                               ; preds = %tail
  ...
  %48 = call i32 @internal_api(i32 3, i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #6
  %49 = mul nsw i32 %47, %48
  %50 = call i32 @internal_api(i32 4, i8* null, i8* bitcast (i32 (i32, i8**)* @0 to i8*)) #6
  %51 = mul nsw i32 %49, %50
  %52 = call i32 @internal_api(i32 5, i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* bitcast (i32 (i32, i8**)* @0 to i8*)) #6
...
.exit:                                            ; preds = %30, %34
  ...
  %56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %54, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i32 %55) #6

; ModuleID = 'slash/main.o.a.i.p.s.r.i.h.p.s.r.i.bc'
...
6:                                                ; preds = %2
  ...
  %17 = tail call i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*)) #3
  %18 = mul nsw i32 %16, %17
  %19 = tail call i32 @"__occam_spec.internal_api(0x4,null,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*)) #3
  %20 = mul nsw i32 %18, %19
  %21 = tail call i32 @"__occam_spec.internal_api(0x5,?,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* bitcast (i32 (i32, i8**)* @0 to i8*)) #3
...
entry1:                                           ; preds = %entry
  ...
  %10 = tail call i32 @"__occam_spec.libcall(?,0x1)"(i32 %9)
  %11 = tail call i64 @atol(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @new_argv.1, i64 0, i64 0)) #4
  %12 = trunc i64 %11 to i32
  %13 = tail call i32 @"__occam_spec.libcall(?,0x2)"(i32 %12)
  %14 = mul nsw i32 %13, %10
  %15 = tail call i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %16 = mul nsw i32 %14, %15
  %17 = tail call i32 @"__occam_spec.internal_api(0x4,null,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %18 = mul nsw i32 %16, %17
  %19 = tail call i32 @"__occam_spec.internal_api(0x5,?,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %20 = mul nsw i32 %18, %19

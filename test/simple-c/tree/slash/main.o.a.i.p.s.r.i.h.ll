...
6:                                                ; preds = %2
  ...
  %11 = tail call i32 @"__occam_spec.libcall(?,0x1)"(i32 %10)
  %12 = load i8*, i8** %7, align 8
  %13 = tail call i64 @atol(i8* %12) #4
  %14 = trunc i64 %13 to i32
  %15 = tail call i32 @"__occam_spec.libcall(?,0x2)"(i32 %14)
  %16 = mul nsw i32 %15, %11
  %17 = tail call i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %18 = mul nsw i32 %16, %17
  %19 = tail call i32 @"__occam_spec.internal_api(0x4,null,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*))
  %20 = mul nsw i32 %18, %19
  %21 = tail call i32 @"__occam_spec.internal_api(0x5,?,?)"(i8* bitcast (i32 (i32, i8**)* @0 to i8*), i8* bitcast (i32 (i32, i8**)* @0 to i8*))

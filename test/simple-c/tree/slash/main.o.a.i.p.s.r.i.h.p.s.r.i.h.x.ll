; ModuleID = 'slash/main.o.a.i.p.s.r.i.h.p.s.r.i.h.x.bc'
...
define internal i32 @3(i32 %0, i8** nocapture readonly %1) #0 {
  %3 = icmp eq i32 %0, 2
...
6:                                                ; preds = %2
  ...
  %17 = tail call i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*)) #3
  %18 = mul nsw i32 %16, %17
  %19 = tail call i32 @"__occam_spec.internal_api(0x4,null,?)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*)) #3
  %20 = mul nsw i32 %18, %19
  %21 = tail call i32 @"__occam_spec.internal_api(0x5,?,?)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*), i8* bitcast (i32 (i32, i8**)* @3 to i8*)) #3
...
23:                                               ; preds = %6, %4
  ...
  %26 = tail call i32 (%0*, i8*, ...) @fprintf(%0* %25, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @0, i64 0, i64 0), i32 %24) #3
  ret i32 %24
}
...
4:                                                ; preds = %2
  ...
  %11 = tail call i64 @atol(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i64 0, i64 0)) #4
  %12 = trunc i64 %11 to i32
  %13 = tail call i32 @"__occam_spec.libcall(?,0x1)"(i32 %12)
  %14 = tail call i64 @atol(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i64 0, i64 0)) #4
  %15 = trunc i64 %14 to i32
  %16 = tail call i32 @"__occam_spec.libcall(?,0x2)"(i32 %15)
  %17 = mul nsw i32 %16, %13
  %18 = tail call i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*))
  %19 = mul nsw i32 %17, %18
  %20 = tail call i32 @"__occam_spec.internal_api(0x4,null,?)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*))
  %21 = mul nsw i32 %19, %20
  %22 = tail call i32 @"__occam_spec.internal_api(0x5,?,?)"(i8* bitcast (i32 (i32, i8**)* @3 to i8*), i8* bitcast (i32 (i32, i8**)* @3 to i8*))
  %23 = mul nsw i32 %21, %22
  %24 = load %0*, %0** @stderr, align 8
  %25 = tail call i32 (%0*, i8*, ...) @fprintf(%0* %24, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @0, i64 0, i64 0), i32 %23) #3
  ret i32 %23
...
declare i32 @"__occam_spec.internal_api(0x5,?,?)"(i8*, i8*) local_unnamed_addr

declare i32 @"__occam_spec.internal_api(0x4,null,?)"(i8*) local_unnamed_addr

declare i32 @"__occam_spec.internal_api(0x3,?,S:B9A)"(i8*) local_unnamed_addr

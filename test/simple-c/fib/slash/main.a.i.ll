...
define internal i32 @fibo(i32 %0) local_unnamed_addr #0 {
  %2 = icmp slt i32 %0, 2
...
21:                                               ; preds = %tail
  %22 = call i32 @fibo(i32 15) #3
  %23 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i32 15, i32 %22) #3
  br label %.exit

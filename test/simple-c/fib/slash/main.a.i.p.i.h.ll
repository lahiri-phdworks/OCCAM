; ModuleID = 'slash/main.a.i.p.i.h.bc'
...
@new_argv.1 = private constant [3 x i8] c"10\00"
...
entry1:                                           ; preds = %entry
  ...
  %8 = tail call fastcc i32 @"__occam_spec.fibo(0xF)"()
  %9 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), i32 15, i32 %8) #2
...
define internal fastcc i32 @"__occam_spec.fibo(0xF)"() unnamed_addr #1 {
  ret i32 610
}

attributes #0 = { nofree nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }

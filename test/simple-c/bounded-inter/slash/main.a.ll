...
define dso_local i32 @0(i32 %0, i8** %1) #0 {
  %3 = call i32 @libcall(i32 1, i32 2)
  %4 = call i32 @libcall(i32 3, i32 4)
  %5 = call i32 @libcall(i32 5, i32 6)
  %6 = call i32 @libcall(i32 7, i32 8)
...
tail:                                             ; preds = %header
  %20 = call i32 @libcall(i32 1, i32 2) #3
  %21 = call i32 @libcall(i32 3, i32 4) #3
  %22 = call i32 @libcall(i32 5, i32 6) #3
  %23 = call i32 @libcall(i32 7, i32 8) #3

...
define i32 @"__occam_spec.add_three(0x5,0x2)"() local_unnamed_addr #0 {
  ret i32 8
}

; Function Attrs: noinline norecurse nounwind readnone uwtable
define i32 @"__occam_spec.add_two(0x5,0x2)"() local_unnamed_addr #0 {
  ret i32 7
}

; Function Attrs: noinline norecurse nounwind readnone uwtable
define i32 @"__occam_spec.add_one(0x5,0x2)"() local_unnamed_addr #0 {
  ret i32 6
}

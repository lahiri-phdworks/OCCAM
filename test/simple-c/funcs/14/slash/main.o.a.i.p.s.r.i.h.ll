; ModuleID = 'slash/main.o.a.i.p.s.r.i.h.bc'
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %1 = load i32 (i32)*, i32 (i32)** @_fun2, align 8
  %2 = tail call i32 @square(i32 7) #4
  %3 = load i32 (i32)*, i32 (i32)** @_fun1, align 8
  %4 = icmp eq i32 (i32)* %3, @decr
  br i1 %4, label %if.true.specialize_funcptr, label %if.false.specialize_funcptr

if.true.specialize_funcptr:                       ; preds = %0
  %5 = tail call i32 @"__occam_spec.execute_call(?,0x5)"(i32 (i32)* %3)
  br label %if.end.specialize_funcptr

if.false.specialize_funcptr:                      ; preds = %0
  %6 = tail call i32 @"__occam_spec.execute_call(?,0x5)"(i32 (i32)* @incr)
  br label %if.end.specialize_funcptr

if.end.specialize_funcptr:                        ; preds = %if.false.specialize_funcptr, %if.true.specialize_funcptr
  %7 = phi i32 [ %6, %if.false.specialize_funcptr ], [ %5, %if.true.specialize_funcptr ]
  %8 = add nsw i32 %7, %2
  %9 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %8) #4
  ret i32 0
}

declare dso_local i32 @execute_call(i32 (i32)*, i32) local_unnamed_addr #3

declare dso_local i32 @printf(i8*, ...) local_unnamed_addr #3

declare i32 @"__occam_spec.execute_call(?,0x5)"(i32 (i32)*)

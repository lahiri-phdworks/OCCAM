; ModuleID = 'slash/main_static.a.i.p.i.h.bc'
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %4 = tail call fastcc i32 @execute_call(i32 (i32)* %3)
  %5 = add nsw i32 %4, %2
  %6 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %5) #4
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal fastcc i32 @execute_call(i32 (i32)* nocapture %0) unnamed_addr #0 {
  %2 = icmp eq i32 (i32)* %0, @decr
  br i1 %2, label %if.true.direct_targ, label %if.false.orig_indirect

if.true.direct_targ:                              ; preds = %1
  %3 = tail call i32 @decr(i32 5) #4
  br label %if.end.icp

if.false.orig_indirect:                           ; preds = %1
  %4 = tail call i32 @incr(i32 5) #4
  br label %if.end.icp

if.end.icp:                                       ; preds = %if.false.orig_indirect, %if.true.direct_targ
  %5 = phi i32 [ %4, %if.false.orig_indirect ], [ %3, %if.true.direct_targ ]
  ret i32 %5
}

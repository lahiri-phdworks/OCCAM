; ModuleID = 'slash/library.o.i.p.s.r.i.h.p.s.r.bc'
...
define dso_local i32 @"__occam_spec.execute_call(?,0x5)"(i32 (i32)* nocapture %0) local_unnamed_addr #1 {
  %2 = tail call i32 %0(i32 5) #2
  ret i32 %2
}
...
; Function Attrs: alwaysinline nounwind uwtable
define dso_local i32 @"__occam_spec.execute_call(incr,0x5)"() local_unnamed_addr #1 {
  %1 = tail call i32 @incr(i32 5) #2
  ret i32 %1
}

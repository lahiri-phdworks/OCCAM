; ModuleID = 'slash/library.o.i.p.s.r.i.h.p.s.r.i.h.p.s.r.i.h.p.s.r.i.h.p.s.r.i.h.bc'
...
define dso_local i32 @"__occam_spec.execute_call(decr,0x5)"() local_unnamed_addr #0 {
  %1 = tail call i32 @"__occam_spec.decr(0x5)"() #1
  ret i32 %1
}

declare i32 @"__occam_spec.incr(0x5)"() local_unnamed_addr

declare i32 @"__occam_spec.decr(0x5)"() local_unnamed_addr

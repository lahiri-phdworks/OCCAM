; ModuleID = 'slash/library.o.i.p.s.r.i.h.p.s.r.i.h.p.s.r.i.h.bc'
...
declare i32 @incr(i32) local_unnamed_addr

; Function Attrs: alwaysinline nounwind uwtable
define dso_local i32 @"__occam_spec.execute_call(incr,0x5)"() local_unnamed_addr #0 {
  %1 = tail call i32 @"__occam_spec.incr(0x5)"()
  ret i32 %1
}

declare i32 @decr(i32)
...
declare i32 @"__occam_spec.incr(0x5)"()

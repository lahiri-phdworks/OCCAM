; ModuleID = 'slash/main.o.a.i.p.s.r.i.h.p.s.r.i.h.p.s.r.i.h.bc'
...
if.end.specialize_funcptr:
  ...
  br i1 %2, label %if.true.specialize_funcptr, label %if.false.specialize_funcptr

if.true.specialize_funcptr:                       ; preds = %if.end.specialize_funcptr
  %3 = tail call i32 @"__occam_spec.execute_call(decr,0x5)"()
  br label %if.end.specialize_funcptr1

if.false.specialize_funcptr:                      ; preds = %if.end.specialize_funcptr
  %4 = tail call i32 @"__occam_spec.execute_call(incr,0x5)"() #4
  br label %if.end.specialize_funcptr1
...
if.end.specialize_funcptr1:                       ; preds = %if.false.specialize_funcptr, %if.true.specialize_funcptr
  ...
  %6 = add nsw i32 %5, %0
  %7 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %6) #4
  ret i32 0
}
...
; Function Attrs: noinline norecurse nounwind readnone uwtable
define dso_local i32 @"__occam_spec.incr(0x5)"() #2 {
  %1 = add nsw i32 5, 1
  ret i32 %1
}

declare i32 @"__occam_spec.execute_call(decr,0x5)"()

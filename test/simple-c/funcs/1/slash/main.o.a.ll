...
define dso_local i32 @0(i32 %0, i8** %1) #0 {
  ...
  %10 = call i32 @call(i32 (i32, i8*)* @test, i32 %6, i8* %9)
  ret i32 %10
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @test(i32 %0, i8* %1) #1 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
  store i32 %0, i32* %4, align 4
...
declare dso_local i32 @call(i32 (i32, i8*)*, i32, i8*) #2
...
tail:                                             ; preds = %header
  ...
  %29 = call i32 @call(i32 (i32, i8*)* @test, i32 %26, i8* %28) #5

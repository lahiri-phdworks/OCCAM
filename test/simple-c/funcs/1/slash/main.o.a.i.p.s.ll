...
declare dso_local i32 @call(i32 (i32, i8*)*, i32, i8*) local_unnamed_addr #1
...
entry1:                                           ; preds = %entry
  ...
  %8 = tail call i32 @call(i32 (i32, i8*)* nonnull @test, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @new_argv, i64 0, i64 0)) #2
  ret i32 %8

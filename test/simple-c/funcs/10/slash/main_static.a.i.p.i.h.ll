...
define internal i32 @incr(i32 %0) local_unnamed_addr #0 {
  %2 = add nsw i32 %0, 1
  ret i32 %2
}
...
define dso_local i32 @main() local_unnamed_addr #1 {
  %1 = tail call fastcc i32 @execute_call()
  %2 = icmp eq i32 %1, 6
...
; Function Attrs: noinline norecurse nounwind readnone uwtable
define internal fastcc i32 @execute_call() unnamed_addr #0 {
  %1 = tail call i32 @incr(i32 5)
  ret i32 %1
}

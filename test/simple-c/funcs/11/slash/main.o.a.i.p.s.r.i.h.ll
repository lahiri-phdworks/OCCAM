...
define dso_local i32 @main() local_unnamed_addr #2 {
  ...
  %2 = tail call i32 @"__occam_spec.execute_call(incr,0x5)"()
  %3 = icmp eq i32 %2, 6
  %.sink = select i1 %3, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0)
  %4 = tail call i32 (i8*, ...) @printf(i8* %.sink) #4
  ret i32 0
}
...
declare i32 @"__occam_spec.execute_call(incr,0x5)"()

; ModuleID = 'slash/main_static.a.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@_fun = common dso_local global i32 (i32)* null, align 8
@fun = dso_local global i32 (i32)** @_fun, align 8
...
define dso_local void @init() #0 {
  %1 = load i32 (i32)**, i32 (i32)*** @fun, align 8
  store i32 (i32)* @incr, i32 (i32)** %1, align 8
  ret void
}
...
define dso_local i32 @main() #0 {
  ...
  call void @init()
  %3 = load i32 (i32)**, i32 (i32)*** @fun, align 8
  %4 = load i32 (i32)*, i32 (i32)** %3, align 8
  %5 = call i32 @execute_call(i32 (i32)* %4, i32 5)
...
10:                                               ; preds = %0
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i64 0, i64 0))
  br label %12
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @execute_call(i32 (i32)* %0, i32 %1) #0 {

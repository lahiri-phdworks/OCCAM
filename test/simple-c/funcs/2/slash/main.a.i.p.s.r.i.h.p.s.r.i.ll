...
entry1:                                           ; preds = %entry
  ...
  %12 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0)) #1
  %13 = tail call i32 @"__occam_spec.add_three(0x4,0x4)"()
  %14 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), i32 %13) #1
  ret i32 %13
...
declare i32 @"__occam_spec.add_three(0x4,0x4)"() local_unnamed_addr

...
38:                                               ; preds = %35
  ...
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0)) #3
  br label %53
...
43:                                               ; preds = %40
  ...
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %52
...
48:                                               ; preds = %45
  ...
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i64 0, i64 0)) #3
  br label %51
...
57:                                               ; preds = %54
  ...
  %61 = call i32 %58(i32 %59, i32 %60) #3
...
.exit:                                            ; preds = %57, %62
  ...
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), i32 %63) #3

...
4:                                                ; preds = %2
  ...
  %15 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @0, i64 0, i64 0)) #1
  %16 = tail call i32 @"__occam_spec.add_three(0x4,0x4)"()
  %17 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i64 0, i64 0), i32 %16) #1
  ret i32 %16

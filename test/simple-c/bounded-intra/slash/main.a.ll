...
define dso_local i32 @nd_int() #0 {
  %1 = call i64 @time(i64* null) #5
  %2 = trunc i64 %1 to i32
  call void @srand(i32 %2) #5
  %3 = call i32 @rand() #5
  ret i32 %3
}
...
19:                                               ; preds = %17, %14, %9, %4
  %.0 = phi i32 [ %6, %4 ], [ %11, %9 ], [ %16, %14 ], [ %18, %17 ]
  ret i32 %.0
}
...
define dso_local i32 @0(i32 %0, i8** %1) #2 {
  %3 = call i32 @nd_int()
  %4 = call i32 @nd_int()
  %5 = call i32 @libcall(i32 %3, i32 %4)
  %6 = call i32 @libcall(i32 1, i32 2)
  %7 = call i32 @libcall(i32 3, i32 4)
  %8 = call i32 @libcall(i32 5, i32 6)
  %9 = call i32 @libcall(i32 7, i32 8)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 %5, i32 %6, i32 %7, i32 %8, i32 %9)
  ret i32 0
}
...
tail:                                             ; preds = %header
  %20 = call i32 @nd_int() #5
  %21 = call i32 @nd_int() #5
  %22 = call i32 @libcall(i32 %20, i32 %21) #5
  %23 = call i32 @libcall(i32 1, i32 2) #5
  %24 = call i32 @libcall(i32 3, i32 4) #5
  %25 = call i32 @libcall(i32 5, i32 6) #5
  %26 = call i32 @libcall(i32 7, i32 8) #5
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 %22, i32 %23, i32 %24, i32 %25, i32 %26) #5
  ret i32 0
}

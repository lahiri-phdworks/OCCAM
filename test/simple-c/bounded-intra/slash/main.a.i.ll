...
; Function Attrs: noinline nounwind uwtable
define internal i32 @libcall(i32 %0, i32 %1) #0 {
  %3 = icmp eq i32 %0, 0
...
tail:                                             ; preds = %header
  %20 = call i32 @nd_int() #4
  %21 = call i32 @nd_int() #4
  %22 = call i32 @libcall(i32 %20, i32 %21) #4
  %23 = call i32 @libcall(i32 1, i32 2) #4
  %24 = call i32 @libcall(i32 3, i32 4) #4
  %25 = call i32 @libcall(i32 5, i32 6) #4
  %26 = call i32 @libcall(i32 7, i32 8) #4
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 %22, i32 %23, i32 %24, i32 %25, i32 %26) #4
  ret i32 0
}

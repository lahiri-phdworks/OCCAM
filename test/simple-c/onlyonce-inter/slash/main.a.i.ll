...
declare dso_local i32 @libcall1(i32, i32) #0

declare dso_local i32 @libcall2(i32, i32) #0
...
tail:                                             ; preds = %header
  %20 = call i32 @libcall1(i32 1, i32 2) #2
  %21 = call i32 @libcall2(i32 3, i32 4) #2
  %22 = call i32 @libcall1(i32 5, i32 6) #2
  %23 = call i32 @libcall1(i32 7, i32 8) #2
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32 %20, i32 %21, i32 %22, i32 %23) #2
  ret i32 0
}

...
declare dso_local i32 @libcall1(i32, i32) local_unnamed_addr #0

declare dso_local i32 @libcall2(i32, i32) local_unnamed_addr #0
...
entry1:                                           ; preds = %entry
  ...
  %8 = tail call i32 @libcall1(i32 1, i32 2) #1
  %9 = tail call i32 @"__occam_spec.libcall2(0x3,0x4)"()
  %10 = tail call i32 @libcall1(i32 5, i32 6) #1
  %11 = tail call i32 @libcall1(i32 7, i32 8) #1
...
declare i32 @"__occam_spec.libcall2(0x3,0x4)"()

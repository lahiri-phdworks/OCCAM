...
_PREVIRTTYPE = _descriptor.Descriptor(
    ...
    nested_types=[_PREVIRTTYPE_INT, _PREVIRTTYPE_VEC,
                  _PREVIRTTYPE_STR, _PREVIRTTYPE_FLOAT, _PREVIRTTYPE_GLOBAL, ],
    enum_types=[
    ],
    options=None,
    is_extendable=False,
...
_CALLREWRITE.fields_by_name['args']._options = _descriptor._ParseOptions(
